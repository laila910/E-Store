                ...
                <div class="container">
                 ...
                 enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="address" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Address ">
                 </div>

                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter country</label>
                     <input type="text" name="country" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter country ">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter City</label>
                     <input type="text" name="city" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter city ">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter State</label>
                     <input type="text" name="state" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter state ">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter ZipCode</label>
                     <input type="text" name="zipCode" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Zipcode ">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Another Address</label>
                     <input type="text" name="anotheraddress" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Another Address ">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter 	creditcard</label>
                     <input type="text" name="creditcard" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter creditcard ">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter 	creditcard Type Id</label>
                     <input type="text" name="creditcardtypeid" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter creditcard Type Id">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Card Expiration Month</label>
                     <input type="text" name="cardExpMon" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter card Expiration Month">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Card Expiration Year</label>
                     <input type="text" name="cardExpYr" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter card Expiration Year">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Shipping Address</label>
                     <input type="text" name="shipaddress" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Shipping Address">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Shipping Country</label>
                     <input type="text" name="shipcountry" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Shipping Country">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Shipping City</label>
                     <input type="text" name="shipcity" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Shipping City">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Shipping State</label>
                     <input type="text" name="shipstate" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Shipping State">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Shipping ZipCode</label>
                     <input type="text" name="shipzipcode" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Shipping ZipCode">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Billing Address</label>
                     <input type="text" name="billingaddress" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Billing Address">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Billing Country</label>
                     <input type="text" name="billingcountry" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Billing Country">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Billing City</label>
                     <input type="text" name="billingcity" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Billing City">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Billing State</label>
                     <input type="text" name="billingstate" class="form-control" id="exampleInputName" aria-describedby=""
                         placeholder="Enter Billing State">
                  </div>
                 <div class="form-group">
                     <label for="exampleInputEmail1">Enter Billing ZipCode</label>
                     <input type="text" name="billingzipcode" class="form-control" id="exampleInputName" aria-describedby=""
